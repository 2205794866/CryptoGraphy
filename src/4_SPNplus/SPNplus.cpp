...
ull s[2][16] = {{14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7, }, {14, 3, 4, 8, 1, 12, 10, 15, 7, 13, 9, 6, 11, 2, 0, 5, }};
ull p[2][64] = {{5, 40, 57, 51, 61, 53, 43, 32, 38, 62, 33, 12, 44, 46, 49, 52, 15, 39, 10, 59, 4, 2, 9, 20, 3, 28, 26, 17, 42, 19, 37, 29, 47, 0, 27, 16, 23, 1, 22, 24, 31, 60, 11, 55, 41, 25, 34, 48, 45, 63, 36, 56, 6, 50, 58, 35, 30, 8, 7, 54, 13, 14, 21, 18, },33, 37, 21, 24, 20, 0, 52, 58, 57, 22, 18, 42, 11, 60, 61, 16, 35, 27, 63, 29, 23, 62, 38, 36, 39, 45, 26, 34, 25, 31, 56, 40, 7, 10, 46, 55, 50, 30, 8, 17, 1, 44, 28, 6, 12, 48, 13, 32, 47, 14, 53, 3, 15, 5, 59, 43, 51, 2, 54, 19, 41, 4, 9, 49, };
...
int main()
{
...
#endif
    // 秘钥
    ull k1 = 0, k2 = 0, key[5], plaintext = 0, ciphertext = 0, initialValue = 6420946196872948572;
    ...
    for (int i = 0; i < (INPUTBYTES / SPNBYTES); i++)
    {
        ...
        // printf("%08llx\n", plaintext);
        // printf("%08llx\n", SPN(key, ciphertext, 1));
        fwrite(&ciphertext, SPNBYTES, 1, stdout);
        initialValue = ciphertext;
    }
