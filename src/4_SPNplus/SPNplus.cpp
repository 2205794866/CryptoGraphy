...
ull s[2][16] = {{11, 6, 5, 8, 3, 2, 9, 13, 1, 15, 0, 7, 14, 4, 10, 12, },10, 8, 5, 4, 13, 2, 1, 11, 3, 6, 14, 0, 15, 7, 12, 9, };
...
#endif
    // 秘钥
    ull k1 = 0, k2 = 0, key[5], plaintext = 0, ciphertext = 0, initialValue = 22220012;
